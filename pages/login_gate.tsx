...
const LoginGate: React.FC<LoginPageProps> = ({ onGuestLogin, onAdminLogin }) => {
  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center p-4 md:p-8 animate-fade">
      <div className="w-full max-w-6xl grid grid-cols-1 md:grid-cols-12 overflow-hidden card-luxury bg-white shadow-2xl border-slate-200 min-h-[600px]">
        
        {/* Left Section: Hero Branding */}
        <div className="relative h-64 md:h-auto md:col-span-7 overflow-hidden group">
          <img 
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-t md:bg-gradient-to-r from-[#1B2559] via-[#1B2559]/40 to-transparent p-10 md:p-20 flex flex-col justify-end md:justify-center text-white">
            <div className="relative z-10">
              ...
              <p className="hidden md:block text-slate-200 max-w-md font-medium text-base leading-relaxed opacity-90">
        ...
        {/* Right Section: Form */}
        <div className="md:col-span-5 p-10 md:p-16 flex flex-col justify-center bg-white border-l border-slate-100">
