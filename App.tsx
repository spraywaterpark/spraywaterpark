      ...
      <main className="flex-1 w-full flex justify-center px-3 md:px-6 py-6">
        <div className="w-full max-w-7xl">
          <Routes>
            ...
            <Route path="/admin" element={auth.role === 'admin' ? <AdminPortal bookings={bookings} settings={settings} onUpdateSettings={handleUpdateSettings} syncId={syncId} onSyncSetup={setSyncId} /> : <Navigate to="/" />} />
